        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <a className="nav-link active text-white navbarText" aria-current="page" href="https://drive.google.com/file/d/18X8kb-41f96ljo4SeAgmQcrCvo0JU5SE/view?usp=sharing" target='_blank' rel="noreferrer" style={{ fontFamily: 'Trebuchet MS', fontSize: '120%' }}>Resume <i className="fa-solid fa-cloud-arrow-down"></i></a>
              </li>
            </ul>
          </div>
        </div>
