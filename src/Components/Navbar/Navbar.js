        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item">
                <a className="nav-link active text-white navbarText" aria-current="page" href="https://drive.google.com/file/d/1tuM6TWnE1U6ZdVmWPzeziaCLUdCng0B8/view?usp=sharing" target='_blank' rel="noreferrer"  style={{fontFamily:'Trebuchet MS', fontSize:'120%'}}>Resume <i className="fa-solid fa-download fs-5"></i></a>
              </li>
            </ul>
          </div>
        </div>
