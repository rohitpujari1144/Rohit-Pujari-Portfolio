...
function Contact() {
  ...
  return (
    <>
      <div id='contact' className='d-flex justify-content-evenly contactMainDiv mb-5'>
        <div className='col-5 contactLeftDiv'>
          <div className=''>
        ...
        <div className='border col-4 rounded border-2 contactFormDiv'>
          <form ref={form}>
            <div className='m-3'>
